...
4. 답변은 원고의 내용을 바탕으로 하되, 모바일 기기의 아코디언 UI 가독성을 위해 반드시 "최대 150자 이내"로 명확하게 요약하여 작성하세요.
5. 강조 주의: 답변 내에서 키워드 강조(**볼드체**)를 남발하지 마십시오. 꼭 필요한 경우를 제외하고는 가급적 일반 텍스트로 작성하여 기계적인 느낌을 배제하세요.
6. 출력 형식은 아래 형식을 정확히 따르세요.
