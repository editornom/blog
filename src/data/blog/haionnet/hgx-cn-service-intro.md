...
faqs:
  ...
  - q: "중국 만리방화벽(GFW) 차단 정책이 강화되는 민감한 시기(당대회 등)에도 회선이 안 끊기나요?"
    a: "네, 그렇습니다. 일반 VPN 솔루션들은 GFW의 정밀 패킷 분석(DPI)에 포착되어 수시로 IP가 차단되고 접속이 마비되는 위험이 상존합니다. 반면 하이온넷 HGX-CN은 차이나텔레콤·차이나유니콤의 공식적이고 합법적인 공인 고속 백본 가속 직결 루트를 타기 때문에 국가적인 네트워크 검열 강화 기간에도 IP 차단 우려 없이 100% 끊김 없는 최상의 전송 가속 상태를 견지합니다."
  - q: "HGX-CN 서비스를 사용하면 고정 IP(Static IP)도 함께 발급받아 쓸 수 있나요?"
    a: "네, 물론입니다. 본-지사 간 안전한 보안 IPsec VPN 터널을 구축하거나, 중국 내부 사설망 서버에 보안이 강화된 특정 국산 IP로만 접근해야 하는 통제 환경을 위해 한국 공인 고정 IP 옵션을 유연하게 기본 제공해 드립니다. 이를 활용해 엄격한 사내 인프라 접근 통제를 쉽고 명확하게 설계하실 수 있습니다."
  - q: "사내에서 기존에 쓰고 있던 타사 인터넷이나 방화벽 보안 장비를 교체하거나 설정을 바꿔야 하나요?"
    a: "전혀 그럴 필요가 없습니다. 하이온넷 전용 지능형 가속 장비(H-CPE)는 '브릿지 모드(Bridge Mode)' 및 '이중화 게이트웨이' 구성을 지원하여, 고객사에서 기존에 애용하시던 고성능 방화벽(Fortinet, Juniper, Cisco 등)이나 복잡한 라우팅 설정을 단 1도 건드리지 않고 그 후방에 깔끔하게 연동됩니다. 기존 인프라 보안 정책을 완벽하게 보호하면서 오직 느렸던 중국향 트래픽만 스마트하게 선택 가속합니다."
  - q: "만약 지사에 임대한 가속 CPE 장비에 하드웨어 장애나 고장이 발생하면 수리 및 A/S 처리는 어떻게 되나요?"
    a: "비즈니스 단절을 방어하기 위해 하이온넷은 임대 기간 내내 철저한 무상 하드웨어 라이프사이클 워런티를 약속드립니다. 당사의 24시간 실시간 장애 관제팀에서 먼저 선제적으로 이상 징후를 감지해 복구를 지휘하며, 하드웨어 파손/불량 판정 시 즉각 선출고(Advanced Replacement) 방식으로 최신 교체용 새 장비를 신속히 퀵/택배 배송해 드려 핑 단절 시간을 최소한으로 압축합니다."
  - q: "중국 본토 지사 외에 베트남, 인도네시아, 홍콩 등 타 아시아 지사 간에도 전용망 확장이 가능한가요?"
    a: "네, 완벽하게 확장 가능합니다. 하이온넷은 한-중 전용선(HGX-CN) 솔루션뿐만 아니라 베트남, 인도네시아, 필리핀 등 글로벌 한인 기업들의 진출이 활발한 아세안 주요 국가는 물론이고 글로벌 허브 요충지인 홍콩, 일본까지 망라하는 통합 초고속 글로벌 백본 네트워크를 운영 중입니다. 모든 거점들을 단일 보안 가속 메시망으로 유기적으로 엮어 원스톱으로 관리해 드립니다."
  - q: "계약 약정 기간은 어떻게 되며, 비즈니스 상황에 맞춰 임시로 대역폭 증설이나 변동이 가능한가요?"
    a: "기본 계약 약정 기간은 고객사의 사업 환경에 맞춰 유연하게 맞춤 설계해 드립니다. 특히 대규모 분기 결산이나 시스템 마이그레이션 등 일시적으로 대량의 대역폭 증설이 필요한 시기에는 유연하게 임시 대역폭 요금 증속(Bandwidth Scaling)을 지원하여, 불필요한 통신 고정 예산을 획기적으로 다이어트하는 유동적 재정 관리를 선사해 드립니다."
---
