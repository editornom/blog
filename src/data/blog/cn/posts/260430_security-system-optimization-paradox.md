...
| :--- | :--- | :--- | :--- | :--- |
| <b>安全保障时机</b> | 开发者责任 | 运行时 (持续性) | 编译阶段 | 运行时 (硬件验证) |
| <b>性能开销</b> | 无 (可优化) | 高 (发生 GC 停顿) | 低 (编译时成本) | 极低 (硅片增量) |
| <b>开发难度</b> | 极高 (易出错) | 低 | 极高 (学习曲线) | 中 (需 API 适配) |
| <b>主要风险</b> | 安全漏洞暴露 | 不可预测的延迟 | 灵活性下降及延迟 | 硬件依赖性加深 |
