...
### 相关术语 (Related Words)
* <b>随机鹦鹉 (Stochastic Parrot)</b>：这是一个比喻性术语，用来描述 LLM 并不理解语义，仅通过机械性的统计学习来生成语言的特性。
* <b>检索增强生成 (RAG)</b>：这是一种技术方案，通过实时参考外部可靠信息来提高回答的准确性，从而有效抑制幻觉现象。
* <b>Transformer 架构 (Transformer Architecture)</b>：这是一种基于注意力机制捕捉上下文的模型结构，但其基于概率的运算体系也预示了幻觉产生的先天性原因。