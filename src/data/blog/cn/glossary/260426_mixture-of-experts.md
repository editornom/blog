...
- <b>门控网络 (Gating Network)</b>：决定将输入的 Token 传递给哪个专家并分配权重的控制神经网络。
- <b>稀疏激活 (Sparse Activation)</b>：在整个神经网络中仅激活符合特定条件的某些部分，从而减少资源消耗的方式。
- <b>参数效率 (Parameter Efficiency)</b>：在扩大模型规模的同时，优化实际投入运算资源的性能指标。