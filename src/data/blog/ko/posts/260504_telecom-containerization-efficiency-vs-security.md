...
![Containerization - 운영체제(OS) 커널을 공유하는 컨테이너 방식과 독립된 하이퍼바이저를 사용하는 가상 머신 방식의 구조적 차이를 비교하여 보여주는 그림입니다.](../../../../../source/posts/Containerization/d6e3290e-1.webp)
...
![Containerization - 회로 기판이 결합된 디지털 자물쇠와 레이저 스캐너가 줄지어 있는 컨테이너들을 끊임없이 점검하며 보안을 유지하는 모습입니다.](../../../../../source/posts/Containerization/fc3cdf6b-2.webp)
