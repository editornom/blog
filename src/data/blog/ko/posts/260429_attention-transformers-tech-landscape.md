...
![트랜스포머(Transformer) - 입력 데이터가 멀티 헤드 셀프 어텐션과 피드 포워드 네트워크를 거쳐 처리되는 트랜스포머 모델의 구조적 흐름을 보여주는 도표입니다.](../../../../../source/posts/트랜스포머(Transformer)/88847d3f-0.webp)
...
![트랜스포머(Transformer) - 트랜스포머 AI 모델이 긴 글 속에서 단어 간의 문법적, 의미적 관계를 어떻게 파악하는지 시각적으로 보여주는 자료입니다.](../../../../../source/posts/트랜스포머(Transformer)/895a6735-1.webp)
