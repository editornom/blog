...
![eBPF (extended Berkeley Packet Filter) - 사용자 공간에서 커널 공간까지 eBPF가 실행되는 과정과 검증기, 컴파일러, 주요 연결 지점(Hook)을 설명하는 기술 구조도입니다.](../../../../../source/posts/eBPF_(extended_Berkeley_Packet_Filter)/e031c061-0.webp)
...
![eBPF (extended Berkeley Packet Filter) - 애플리케이션을 외부에서 감시하는 기존 방식과 리눅스 커널 내부에서 직접 실행되는 eBPF 방식의 차이를 비교하여 보여주는 그림입니다.](../../../../../source/posts/eBPF_(extended_Berkeley_Packet_Filter)/daff7c0c-1.webp)
