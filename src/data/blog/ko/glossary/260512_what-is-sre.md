...
## 관련 단어 (Related Words)
* **DevOps**: 소프트웨어 개발과 운영의 협업을 강조하는 문화적 철학으로, SRE는 이를 구체적인 공학적 기법으로 구현한 모델로 평가받습니다.
* **SLO (Service Level Objective)**: 서비스 제공자가 준수하고자 하는 성능 및 가용성에 대한 구체적인 목표치입니다.
* **Error Budget (에러 예산)**: SLO를 달성하기 위해 허용 가능한 시스템 불능 시간의 총량을 의미하며, 새로운 기능의 배포 여부를 결정하는 기준이 됩니다.