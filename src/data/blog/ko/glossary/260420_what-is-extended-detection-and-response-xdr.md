...
description: Extended Detection and Response (XDR)는 엔드포인트, 네트워크, 클라우드 등 다양한 보안 계층의
  데이터를 통합하여 위협을 탐지하고 대응하는 차세대 보안 솔루션입니다.
faqs:
- q: XDR이란 무엇인가요?
...
- q: XDR은 왜 등장하게 되었나요?
  a: 개별 솔루션만으로는 파악하기 힘든 '보안 사일로' 현상을 극복하고, 중복된 알림으로 인한 보안 담당자의 '경보 피로' 문제를 해결하기 위해
    등장했습니다.
...
- q: XDR과 관련된 주요 용어는 무엇인가요?
  a: 엔드포인트 탐지(EDR), 네트워크 탐지(NDR), 보안 정보 및 이벤트 관리(SIEM), 보안 오케스트레이션 및 자동화 대응(SOAR)
    등이 있습니다.
