...
![Conceptual diagram showing the RAG workflow where a user query triggers a search in an external knowledge base to provide context for the Large Language Model's (LLM) response.](../../../../../source/glossary/RAG_(Retrieval-Augmented_Generation)/3f23135c-0.png)
...
<details>
  <summary>What does RAG stand for, and what is its Korean name?</summary>
  <div class="faq-content">

The abbreviation is RAG, which stands for 'Retrieval-Augmented Generation.' In Korean, it is translated literally as '검색 증강 생성' (Geomsaek Jeunggang Saengseong).

  </div>
</details>

<details>
  <summary>What is the background behind the emergence of RAG technology?</summary>
  <div class="faq-content">

It emerged because LLMs often exhibit 'hallucinations'—providing incorrect facts because they lack information on events occurring after their training or private data. RAG was designed to provide models with accurate external data rather than requiring them to be retrained every time.

  </div>
</details>

<details>
  <summary>What are the primary technologies required to build a RAG system?</summary>
  <div class="faq-content">

Core technologies include the LLM (which serves as the foundation for answers), a Vector Database for storing and searching data, Embedding for numerical text conversion, and semantic search technologies for meaning-based retrieval.

  </div>
</details>

<details>
  <summary>What are the advantages of using RAG?</summary>
  <div class="faq-content">

It overcomes the limitations of a model's training data to provide accurate, up-to-date information and specialized knowledge. It also effectively suppresses hallucinations and offers high reliability to users by clearly identifying the sources of information.

  </div>
</details>

<details>
  <summary>What is the critical difference between RAG and Fine-tuning?</summary>
  <div class="faq-content">

RAG is like an 'open-book exam' where the model refers to external materials, whereas Fine-tuning is like 'studying' to acquire knowledge by directly modifying the model's parameters. RAG is faster for updates and more cost-effective, while Fine-tuning is better for mastering specific styles or formats.

  </div>
</details>

<details>
  <summary>How does RAG reduce AI 'hallucinations'?</summary>
  <div class="faq-content">

By including actual document fragments related to the query in the prompt and instructing the model to 'answer based on this content,' it prevents the model from fabricating answers. This induces evidence-based generation, minimizing factual errors.

  </div>
</details>

<details>
  <summary>What role does the 'Vector Database' play in the RAG process?</summary>
  <div class="faq-content">

It serves as a repository that converts user queries into vectors and then quickly identifies the document fragments that are semantically most similar among vast amounts of data. This allows it to supply the LLM with the most relevant reference materials for the user's intent.

  </div>
</details>

<details>
  <summary>How does a RAG system respond when new information arises?</summary>
  <div class="faq-content">

There is no need to retrain the model. You simply update the external database with documents containing the latest information. This significantly reduces operational resources while ensuring the system stays current through real-time knowledge updates.

  </div>
</details>

<details>
  <summary>How can companies practically implement RAG in their business?</summary>
  <div class="faq-content">

Companies can operate AI customer support chatbots based on extensive internal technical documents or product manuals. This improves efficiency by providing real-time, manual-based accurate answers to customer questions along with links to the supporting evidence pages.
